...
type Person struct {
	...
	Emails []string       `protobuf:"bytes,3,rep,name=emails,proto3" json:"emails,omitempty"` // 电子邮件 (repeated表示字段允许重复) slice
	Phones []*PhoneNumber `protobuf:"bytes,4,rep,name=phones,proto3" json:"phones,omitempty"` // 手机号 struct
}
