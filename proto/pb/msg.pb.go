...
type SyncPid struct {
	...
	Pid uint32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"` // 服务器生成的玩家ID
}
...
type BroadCast struct {
	...
	Tp  uint32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` // 1:世界聊天, 2:玩家位置, 3:动作, 4:移动之后的坐标信息
...
func (x *BroadCast) GetPid() uint32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *BroadCast) GetActionData() uint32 {
...
type BroadCast_Content struct {
	Content string `protobuf:"bytes,3,opt,name=Content,proto3,oneof"` // 聊天数据
}
...
type BroadCast_ActionData struct {
	ActionData uint32 `protobuf:"varint,5,opt,name=ActionData,proto3,oneof"` // 玩家具体动作
}
...
type Talk struct {
	...
	Content string `protobuf:"bytes,1,opt,name=content,proto3" json:"content,omitempty"` // 玩家聊天信息
}
...
var file_msg_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x50, 0x69, 0x64, 0x22, 0x91, 0x01, 0x0a,
	0x09, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x43, 0x61, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x50, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x50, 0x69, 0x64, 0x12, 0x0e, 0x0a, 0x02,
	0x54, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x54, 0x70, 0x12, 0x1a, 0x0a, 0x07,
	...
	0x44, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x0a, 0x41, 0x63,
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x50, 0x69, 0x64, 0x12, 0x1a, 0x0a,
